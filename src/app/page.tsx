...
export default function Page() {
  return (
    <main className="page-root" id="home">
      <ScrollStory chapters={scrollChapters} />

      <section className="hero-stage" aria-label="Hero" data-scroll-chapter="hero">
        <header className="topbar topbar--hero" data-reveal="topbar">
      ...
      <div className="page-shell page-shell--content">
